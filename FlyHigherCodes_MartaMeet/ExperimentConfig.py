...
EXPECTED_STIMULUS     = STIMULUS_NUMBER # extra events (e.g. lights‑off)
...
GROUP_IDENTIFIER = "Genotype"  # metadata field used for grouping runs

# Experimental groups (keep 'Loom' as protocol label)
EXPERIMENTAL_GROUPS = {
    "DGRP57": {
        "label": "DGRP57",                # group name
        "idValue": "DGRP57",  # identifier in filename metadata          
    },
    "DGRP129": {
        "label": "DGRP129",                # group name
        "idValue": "DGRP129",  # identifier in filename metadata          
    },
    "DGRP315": {
        "label": "DGRP315",                # group name
        "idValue": "DGRP315",  # identifier in filename metadata          
    },
    "DGRP859": {
        "label": "DGRP859",                # group name
        "idValue": "DGRP859",  # identifier in filename metadata          
    },
}
